...
console.log(dinosaur_tyran.weight);

// What was the diet of a velociraptor?
console.log(dinosaur_veloci.diet);

// How long was a stegosaurus?
console.log(dinosaur_stegos.length);

// What time period did tyrannosaurus live in?
console.log(dinosaur_tyran.period);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
dinosaur_tyran.roar = function () {
  return "RAWERSRARARWERSARARARRRR!";
}

console.log(dinosaur_tyran.roar());
...
const populationTotal = zooAnimals.reduce(function (totalAnimals, itm) {
  return totalAnimals + itm.population;
}, 0);
